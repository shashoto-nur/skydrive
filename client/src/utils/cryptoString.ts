...
const encryptStr = async (string: string, algorithm: { name: string; iv: Uint8Array }, key: CryptoKey) => {
...
const decryptStr = async (encBase64String: string, algorithm: { name: string; iv: Uint8Array }, key: CryptoKey) => {
